/* =============================================================================
 * Suika OS — Interrupt Descriptor Table (32-bit)
 * ============================================================================= */
...
static void idt_set_entry(int index, uint32_t base, uint16_t sel, uint8_t flags) {
...
static void pic_remap(void) {
    ...
    outb(0x21, 0xFC);  /* Enable IRQ0 (timer) + IRQ1 (keyboard) */
    outb(0xA1, 0xFF);
}
...
void idt_init(void) {
    ...
    idt_set_entry(18, (uint32_t)isr17, 0x08, 0x8E);
